...
def upgrade():
    ...
    op.create_foreign_key(f"{new_reward_table}_reward_config_id_fkey", new_reward_table, referent_table, ["reward_config_id"], ["id"])
    ...
    op.drop_constraint("voucher_type_slug_retailer_slug_unq", table_name=old_voucher_config_table)
    ...
    # # Drop indices
    # for index in (f"ix_{old_voucher_file_log_table}_name", f"ix_{new_reward_file_log_table}_agent_type"):
...
def downgrade():
    ...
    # op.drop_constraint("reward_slug_retailer_slug_unq", table_name=old_reward_config_table)
    ...
    # op.create_foreign_key(f"{new_voucher_update_table}_voucher_id_fkey", new_voucher_update_table, referent_reward_table, ["reward_uuid"], ["id"], ondelete="CASCADE",)
    ...
    # # Drop indices
    # for index in (f"ix_{old_reward_file_log_table}_name", f"ix_{new_voucher_file_log_table}_agent_type"):
