...
def test_post_voucher_allocation_happy_path(
    ...
    resp = client.post(
        f"/bpl/rewards/{voucher_config.retailer_slug}/rewards/{voucher_config.voucher_type_slug}/allocation",
        json=payload,
...
def test_post_voucher_allocation_wrong_retailer(setup: SetupType, voucher_issuance_task_type: TaskType) -> None:
    ...
    resp = client.post(
        f"/bpl/rewards/WRONG-RETAILER/rewards/{voucher_config.voucher_type_slug}/allocation",
        json=payload,
        headers=auth_headers,
    )
...
def test_post_voucher_allocation_wrong_voucher_type(setup: SetupType, voucher_issuance_task_type: TaskType) -> None:
    ...
    resp = client.post(
        f"/bpl/rewards/{voucher_config.retailer_slug}/rewards/WRONG-TYPE/allocation",
        json=payload,
        headers=auth_headers,
    )
