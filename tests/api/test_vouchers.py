...
def test_post_voucher_allocation_happy_path(
    ...
    resp = client.post(
        f"/bpl/rewards/{voucher_config.retailer_slug}/vouchers/{voucher_config.voucher_type_slug}/allocation",
        json=payload,
...
def test_post_voucher_allocation_wrong_retailer(setup: SetupType, voucher_issuance_task_type: TaskType) -> None:
    ...
    resp = client.post(
        f"/bpl/rewards/WRONG-RETAILER/vouchers/{voucher_config.voucher_type_slug}/allocation",
        json=payload,
        headers=auth_headers,
    )
...
def test_post_voucher_allocation_wrong_voucher_type(setup: SetupType, voucher_issuance_task_type: TaskType) -> None:
    ...
    resp = client.post(
        f"/bpl/rewards/{voucher_config.retailer_slug}/vouchers/WRONG-TYPE/allocation",
        json=payload,
        headers=auth_headers,
    )
...
def test_voucher_type_status_ok(
    ...
    for transition_status in ("cancelled", "ended"):
        ...
        resp = client.patch(
            f"/bpl/rewards/{voucher_config.retailer_slug}/rewards/{voucher_config.voucher_type_slug}/status",
...
def test_voucher_type_status_invalid_retailer(setup: SetupType) -> None:
    ...
    resp = client.patch(
        f"/bpl/rewards/unknown-retailer/rewards/{voucher_config.voucher_type_slug}/status",
...
def test_voucher_type_status_voucher_type_not_found(setup: SetupType) -> None:
    ...
    resp = client.patch(
        f"/bpl/rewards/{voucher_config.retailer_slug}/rewards/invalid-voucher-type/status",
        json={"status": "cancelled"},
        headers=auth_headers,
    )
    assert resp.status_code == HttpErrors.UNKNOWN_VOUCHER_TYPE.value.status_code
