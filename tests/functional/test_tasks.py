...
from app.tasks.voucher_cancellation import cancel_rewards
...
def test_cancel_rewards(mock_datetime: mock.Mock, db_session: Session, cancel_rewards_retry_task: RetryTask) -> None:
    mock_datetime.utcnow.return_value = fake_now
