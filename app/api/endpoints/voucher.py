...
@router.post(
    ...
    dependencies=[user_is_authorised],
)
async def allocation(
    ...
    voucher = await crud.get_allocable_voucher(db_session, voucher_config)
    voucher_allocation = await crud.create_allocation(db_session, voucher, voucher_config, payload.account_url)
